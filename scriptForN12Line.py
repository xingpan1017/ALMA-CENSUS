#############################################################################
## Image line emission of N12
#############################################################################
## Created by Xing Pan at NJU, Nov 12, 2025
...
#############################################################################
## cd /reduction/xingpan/ALMA/CENSUS/maps/N12/Line
## Restore .ms file before continuum flag
myvis_list = ["/share/group/panxing/CENSUS/ALMA/calibrated/N03_N12_N30/cygxn12_X176c0.ms"]
...
for i in range(6):
    imvis = myvis_list[0]
    imname = './spwcube/N12_X176c0_cube_spw%d'%i
    nit = 50
    cellsize = '0.2arcsec'
    imsize = 200
    robust = 0.5
...
# Line-free channels
fc_spw_list = ["0:100~600;760~940", "0:10~330;370~450;500~700", "0:50~600;700~920", "0:50~450;550~920", "0:50~900;1100~1800", "0:100~400;500~850;1000~1200"]
